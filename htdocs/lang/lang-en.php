...
$lang['cardRegisterManualLinks'] = "<p>You can also connect cards to folders manually. The manual explains how to <a href='https://github.com/notmyown/RPi-Jukebox-RFID/blob/master/docs/MANUAL.md#connecting-to-the-phoniebox-to-add-files' target='–blank'>connect to the phoniebox</a> and <a href='https://github.com/notmyown/RPi-Jukebox-RFID/blob/master/docs/MANUAL.md#registering-cards-manually-through-samba-without-the-web-app' target='_blank'>register cards</a>.</p>";
